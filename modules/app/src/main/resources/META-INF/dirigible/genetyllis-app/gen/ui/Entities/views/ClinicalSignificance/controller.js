...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'genetyllis-app.Entities.ClinicalSignificance.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('genetyllis-app.Entities.ClinicalSignificance.refresh', callback);
		},
		onSignificanceTypeModified: function(callback) {
			on('genetyllis-app.Entities.SignificanceType.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/genetyllis-app/gen/api/Entities/ClinicalSignificance.js';
	var significancetypeidOptionsApi = '/services/v4/js/genetyllis-app/gen/api/Entities/SignificanceType.js';
