...
exports.customDataCount = function() {
	var resultSet = query.execute("SELECT COUNT(*) AS COUNT FROM ALLELEFREQUENCY");
...
function triggerEvent(operation, data) {
	producer.queue("genetyllis-app/Entities/AlleleFrequency/" + operation).send(JSON.stringify(data));
}