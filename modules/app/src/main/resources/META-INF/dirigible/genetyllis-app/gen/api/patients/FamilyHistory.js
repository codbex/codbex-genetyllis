...
const dao = require("genetyllis-app/gen/dao/patients/FamilyHistory");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("FamilyHistory not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/genetyllis-app/gen/api/FamilyHistory.js/" + entity.Id);
