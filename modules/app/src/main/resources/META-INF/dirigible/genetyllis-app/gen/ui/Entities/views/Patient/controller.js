...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'genetyllis-app.Entities.Patient.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('genetyllis-app.Entities.Patient.refresh', callback);
		},
		onGenderModified: function(callback) {
			on('genetyllis-app.Entities.Gender.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/genetyllis-app/gen/api/Entities/Patient.js';
	var genderidOptionsApi = '/services/v4/js/genetyllis-app/gen/api/Entities/Gender.js';
