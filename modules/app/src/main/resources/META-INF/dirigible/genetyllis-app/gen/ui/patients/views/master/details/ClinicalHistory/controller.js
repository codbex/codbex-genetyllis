...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'genetyllis-app.patients.ClinicalHistory.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('genetyllis-app.patients.ClinicalHistory.refresh', callback);
		},
		onPatientModified: function(callback) {
			on('genetyllis-app.patients.Patient.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/genetyllis-app/gen/api/patients/ClinicalHistory.js';
