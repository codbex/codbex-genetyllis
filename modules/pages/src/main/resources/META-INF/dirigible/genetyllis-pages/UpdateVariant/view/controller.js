...
angular.module('page').controller('PageController', function ($scope, $http) {
    var api = "/services/v4/js/genetyllis-pages/UpdateVariant/view/updateRs.js";
    var apiUpload = "/services/v4/js/genetyllis-pages/UpdateVariant/view/updateVariant.js";
