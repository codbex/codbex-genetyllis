...
const dao = require("genetyllis-pages/services/dao/records/File");
...
rs.service()
    ...
    //     var file = request.getJSON();
    //     var result = dao.getFile(file);
    //     if (result) {
    ...
    .get(function (ctx) {
        ...
        if (entity) {
            ...
            http.sendResponseNotFound("File not found");
        }
    })
    .produces(["application/json"])
    .catch(function (ctx, error) {
    ...
    .post(function (ctx, request, response) {
        ...
        response.setHeader("Content-Location", "/services/v4/js/genetyllis-app/gen/api/File.js/" + entity.Id);
