...
const dao = require("genetyllis-pages/services/dao/records/VariantRecord");
...
rs.service()
	...
	.get(function (ctx) {
		...
		if (entity) {
			...
			http.sendResponseNotFound("VariantRecord not found");
		}
	})
	.produces(["application/json"])
	.catch(function (ctx, error) {
	...
	.post(function (ctx, request, response) {
		...
		response.setHeader("Content-Location", "/services/v4/js/genetyllis-app/gen/api/VariantRecord.js/" + entity.Id);
