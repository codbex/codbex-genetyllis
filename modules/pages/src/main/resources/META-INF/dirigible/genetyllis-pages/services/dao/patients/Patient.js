...
exports.filterPatients = function (patient) {
	...
	if (patient.GENETYLLIS_FILTER) {
		filterSql = buildFilterSql(patient.GENETYLLIS_FILTER, filterSql);
	}
...
function initFilterSql() {
	...
	filterSql = 'SELECT DISTINCT GP.* FROM "GENETYLLIS_PATIENT" GP ' +
		...
		'LEFT JOIN "GENETYLLIS_FILTER" GFL ON GVR."VARIANTRECORD_ID" = GFL."FILTER_VARIANTRECORDID" ' +
