...
const dao = require("genetyllis-pages/services/dao/users/Notification");
...
rs.service()
	...
	.get(function (ctx) {
		...
		if (entity) {
			...
			http.sendResponseNotFound("Notification not found");
		}
	})
	.produces(["application/json"])
	.catch(function (ctx, error) {
	...
	.post(function (ctx, request, response) {
		var variantId = request.getJSON();
		var result = dao.getByVariantId(variantId);
		if (result) {
