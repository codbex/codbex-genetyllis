...
rs.service()
	...
	// .resource("getFiles/{analysisId}")
	// .post(function (ctx, request, response) {
	// 	var analysisId = request.getJSON();
	// 	var result = dao.getFiles(analysisId);
	// 	if (result) {
	...
	.resource("getFiles/{analysisId}")
	.get(function (ctx) {
		let analysisId = ctx.pathParameters.analysisId;
	...
	.resource("getFile/{analysisId}/{filePath}")
	.get(function (ctx) {
		let analysisId = ctx.pathParameters.analysisId;
		let filePath = ctx.pathParameters.filePath;
		var result = dao.getFile(analysisId, filePath);
		http.sendResponseOk(result);
	})
	.produces(["application/json"])
	.catch(function (ctx, error) {
